...
public class Vendor {
    ...
    public LocalDate getOffboardingDate() { return offboardingDate; }
    public void setOffboardingDate(LocalDate offboardingDate) { this.offboardingDate = offboardingDate; }
